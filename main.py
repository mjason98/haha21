...
from code.models import trainModels, makeTrain_and_ValData
...
def train_encoder():
    ...
    # This is temporal -------------------
    TEST_DATA_NAME, EVAL_DATA_NAME = makeTrain_and_ValData(TEST_DATA_NAME, class_label='is_humor', df=DATA_FOLDER)
    # This is temporal -------------------
